...
// DORA lead time thresholds in hours based on Accelerate research
const (
	eliteLeadTimeThreshold  = 24.0   // <1 day
	highLeadTimeThreshold   = 168.0  // <1 week (7 days)
	mediumLeadTimeThreshold = 720.0  // <1 month (30 days)
	// Above 30 days is Low performance
)
